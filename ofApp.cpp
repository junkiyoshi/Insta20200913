...
void ofApp::update() {
	...
	for (int radius = 30; radius <= 150; radius += 10) {

		auto noise_seed = ofRandom(1000);
		auto deg = ofMap(ofNoise(noise_seed, ofGetFrameNum() * 0.01), 0, 1, -180, 180);
		this->setRingToMesh(this->face, this->frame, glm::vec3(), radius, 5, 30, 0, deg);
		this->setRingToMesh(this->face, this->frame, glm::vec3(), radius, 5, 30, 180, 180 + deg);
	}
}
